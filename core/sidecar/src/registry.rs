...
fn catalog() -> Vec<RegistryPreset> {
    vec![
        ...
        RegistryPreset {
            id: "driver_search_off",
            title: "Disable automatic driver search",
            category: "basic",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Prevents Windows Update from automatically searching and staging driver updates during normal startup/update activity.",
            current_state_label: "Driver search follows the current Windows Update driver policy.",
            target_state_label: "Automatic driver search is disabled by machine policy.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
        ...
        RegistryPreset {
            id: "global_notifications_off",
            title: "Disable global Windows notifications",
            category: "basic",
            risk: "low",
            requires_admin: false,
            requires_baseline: false,
            expected_benefit: "Reduces toast notification wakeups and foreground interruptions while gaming.",
            current_state_label: "Windows notifications follow the current user notification settings.",
            target_state_label: "Global toast notifications are disabled for the current user.",
            scope: "user-scope",
            mutations: vec![
                RegistryMutation {
                    hive: RegistryHive::Hkcu,
        ...
        RegistryPreset {
            ...
            title: "Disable background UWP applications",
            category: "basic",
            risk: "low",
            requires_admin: false,
            requires_baseline: false,
            expected_benefit: "Stops Store/UWP apps from running background tasks for the current user where Windows allows it.",
            current_state_label: "Background app execution follows the current user privacy setting.",
            target_state_label: "Background UWP apps are disabled for the current user.",
            scope: "user-scope",
            mutations: vec![
                RegistryMutation {
                    hive: RegistryHive::Hkcu,
        ...
        RegistryPreset {
            id: "store_auto_updates_off",
            title: "Disable automatic Microsoft Store app updates",
            category: "basic",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Prevents Store app update downloads from starting during a game or benchmark session.",
            current_state_label: "Microsoft Store app updates follow the current machine policy.",
            target_state_label: "Automatic Store app updates are disabled by policy.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
        ...
        RegistryPreset {
            ...
            title: "Disable Delivery Optimization downloads",
            category: "basic",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Prevents peer/content delivery optimization downloads from waking during latency-sensitive work.",
            current_state_label: "Delivery Optimization follows the current machine download policy.",
            target_state_label: "Delivery Optimization download mode is disabled.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
                path: r"SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config",
        ...
        RegistryPreset {
            ...
            title: "Disable Microsoft Edge startup boost and background mode",
            category: "basic",
            risk: "low",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Stops Edge from preloading and continuing background processes after the browser closes.",
            current_state_label: "Edge background behavior follows the current machine policy.",
            target_state_label: "Edge startup boost and background mode are disabled by policy.",
            scope: "machine-scope",
            mutations: vec![
                RegistryMutation {
                    hive: RegistryHive::Hklm,
        ...
        RegistryPreset {
            id: "print_spooler_off",
            title: "Disable Print Spooler service startup",
            category: "basic",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Removes print spooler service activity on systems that do not print during gaming sessions.",
            current_state_label: "Print Spooler startup follows current service policy.",
            target_state_label: "Print Spooler startup is disabled.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
        ...
        RegistryPreset {
            id: "security_center_on",
            title: "Keep Security Center enabled",
            category: "security",
            risk: "low",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Keeps the Windows Security Center service enabled so protective status remains visible.",
            current_state_label: "Security Center follows current service policy.",
            target_state_label: "Security Center startup is automatic.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
                path: r"SYSTEM\CurrentControlSet\Services\wscsvc",
                value_name: "Start",
                value_type: RegistryValueType::RegDword,
                target_value: RegistryValueData::Dword(2),
            }],
        ...
        RegistryPreset {
            id: "windows_firewall_on",
            title: "Keep Windows Firewall enabled",
            category: "security",
            risk: "low",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Keeps the Windows Firewall service enabled while other performance tweaks are applied.",
            current_state_label: "Windows Firewall follows current service policy.",
            target_state_label: "Windows Firewall service startup is automatic.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
                path: r"SYSTEM\CurrentControlSet\Services\MpsSvc",
                value_name: "Start",
                value_type: RegistryValueType::RegDword,
                target_value: RegistryValueData::Dword(2),
            }],
        ...
        RegistryPreset {
            id: "win32_priority_separation_2a",
            title: "Set Win32PrioritySeparation to 0x2a",
            category: "tweaks",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Sets foreground scheduler quantum separation to a gaming-oriented value used by many Windows tuning profiles.",
            current_state_label: "Win32PrioritySeparation follows the current scheduler setting.",
            target_state_label: "Win32PrioritySeparation is set to 0x2a.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
                ...
                value_type: RegistryValueType::RegDword,
                target_value: RegistryValueData::Dword(42),
            }],
        },
        RegistryPreset {
        ...
        RegistryPreset {
            ...
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Reduces filesystem metadata work by disabling legacy DOS 8.3 short filename creation for new files.",
            current_state_label: "8.3 filename creation follows current NTFS policy.",
            target_state_label: "8.3 filename creation is disabled.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
                path: r"SYSTEM\CurrentControlSet\Control\FileSystem",
        ...
        RegistryPreset {
            id: "application_compatibility_off",
            title: "Disable Application Compatibility inventory",
            category: "tweaks",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Reduces compatibility inventory/background checks that can wake outside the active game session.",
            current_state_label: "Application Compatibility inventory follows current machine policy.",
            target_state_label: "Application Compatibility inventory is disabled by policy.",
            scope: "machine-scope",
            mutations: vec![
                RegistryMutation {
                    hive: RegistryHive::Hklm,
        ...
        RegistryPreset {
            id: "automatic_maintenance_off",
            title: "Disable Automatic Maintenance",
            category: "tweaks",
            risk: "medium",
            requires_admin: true,
            requires_baseline: false,
            expected_benefit: "Prevents Windows Automatic Maintenance from starting background maintenance while the PC is being used for latency-sensitive work.",
            current_state_label: "Automatic Maintenance follows the current scheduler policy.",
            target_state_label: "Automatic Maintenance is disabled by policy.",
            scope: "machine-scope",
            mutations: vec![RegistryMutation {
                hive: RegistryHive::Hklm,
